...
import leaderImage4 from '@/assets/images/leaders/image13.png';
import leaderImage5 from '@/assets/images/leaders/image14.png';
import leaderImage6 from '@/assets/images/leaders/image15.png';
import leaderImage7 from '@/assets/images/leaders/image16.png';
import leaderImage8 from '@/assets/images/leaders/image17.png';
      ...
      >
        <div className="overflow-hidden rounded-xl mb-4">
          <img
            src={office.img}
            alt={office.city}
            className="className="w-full aspect-[4/3] object-cover object-center transition-transform duration-500 group-hover:scale-110""
          />
        </div>
