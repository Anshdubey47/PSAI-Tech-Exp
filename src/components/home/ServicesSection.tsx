...
const services = [
  {
    ...
    description: 'High-performance application from leading brands, configured for government workloads.',
  ...
  },
  {
    ...
    description: 'Our solutions are designed to address the full spectrum of banking technology needs.',
  ...
  },
  {
    ...
    description: 'We can help you and your business with cloud adoption and implementation',
  ...
  },
  {
    ...
    description: 'We provide skilled IT professionals to support, manage, and scale your business operations.',
    href: '/manpower',
  ...
  },
  {
    icon: Wrench,
    title: 'AMC (hardware)',
    description: 'We deliver comprehensive annual maintenance services to ensure reliable and uninterrupted IT infrastructure.',
    href: '/services',
